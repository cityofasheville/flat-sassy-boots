...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget">
		...
		<ul id="admins-list" class="item-list single-line list-group col-xs-12">
			...
			<li class = "list-group-item col-xs-12" style = "box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3); margin : 3px;">
				...
				<div class="col-xs-12">
					<a class="btn btn-warning button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>"><?php _e( 'Demote to Member', 'buddypress' ); ?></a>
				</div>
				<?php endif; ?>
			</li>
			<?php endwhile; ?>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		<div class="bp-widget">
			...
			<?php if ( bp_has_members( '&include=' . bp_group_mod_ids() ) ) : ?>
				<ul id="mods-list" class="item-list single-line list-group col-xs-12">
	...
	<div class="bp-widget">
		...
		<?php if ( bp_group_has_members( 'per_page=15&exclude_banned=0' ) ) : ?>
			...
			<ul id="members-list" class="item-list single-line list-group col-xs-12">
				<?php while ( bp_group_members() ) : bp_group_the_member(); ?>

					<li class="<?php bp_group_member_css_class(); ?> list-group-item col-xs-12" style = "box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3); margin : 3px;">
						<div class="col-xs-12 col-md-10">
							<a  class = "col-xs-12 col-md-1" style = "margin-top : 15px" href="<?php bp_group_member_domain(); ?>">
						...
						<div class="col-xs-12">
							...
							<?php if ( bp_get_group_member_is_banned() ) : ?>
								...
								<a href="<?php bp_group_member_unban_link(); ?>" class="btn btn-success button confirm member-unban" title="<?php esc_attr_e( 'Unban this member', 'buddypress' ); ?>"><?php _e( 'Remove Ban', 'buddypress' ); ?></a>

							<?php else : ?>

								<a href="<?php bp_group_member_ban_link(); ?>" class="btn btn-danger button confirm member-ban" title="<?php esc_attr_e( 'Kick and ban this member', 'buddypress' ); ?>"><?php _e( 'Kick &amp; Ban', 'buddypress' ); ?></a>
								<a href="<?php bp_group_member_promote_mod_link(); ?>" class="btn btn-primary button confirm member-promote-to-mod" title="<?php esc_attr_e( 'Promote to Mod', 'buddypress' ); ?>"><?php _e( 'Promote to Mod', 'buddypress' ); ?></a>
								<a href="<?php bp_group_member_promote_admin_link(); ?>" class="btn btn-success button confirm member-promote-to-admin" title="<?php esc_attr_e( 'Promote to Admin', 'buddypress' ); ?>"><?php _e( 'Promote to Admin', 'buddypress' ); ?></a>

							<?php endif; ?>

								<a href="<?php bp_group_member_remove_link(); ?>" class="btn btn-warning button confirm" title="<?php esc_attr_e( 'Remove this member', 'buddypress' ); ?>"><?php _e( 'Remove from group', 'buddypress' ); ?></a>
